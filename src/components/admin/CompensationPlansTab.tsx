...
import { Plus, Settings, Users, Layers, ArrowRight, Edit, Trash2, Loader2, Copy } from "lucide-react";
import {
...
export function CompensationPlansTab() {
  ...
  const getMetricsCount = () => compPlans?.length || 0;
                  ...
                  <TableRow key={plan.id} className="data-row">
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-1">
                        <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => handleEditPlan(plan)} title="Edit plan">
                          <Edit className="h-4 w-4" />
                        </Button>
                        <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive hover:text-destructive" onClick={() => handleDeletePlan(plan)} title="Delete plan">
                          <Trash2 className="h-4 w-4" />
                        </Button>
                        <Button variant="ghost" size="sm" onClick={() => handleViewPlan(plan)} title="View details">
